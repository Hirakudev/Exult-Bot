...
class Cases(ExultCog):
    ...
    async def cases_display_server_slash(self, itr: discord.Interaction):
        await itr.response.defer()
        bot: ExultBot = itr.client
        followup: discord.Webhook = itr.followup
        guild: discord.Guild = itr.guild
        ...
        formatted_cases: list = discord.utils.as_chunks(_cases, 4)
    ...
    async def cases_display_member_slash(
        ...
        formatted_cases: list = discord.utils.as_chunks(_cases, 5)
