...
class AvatarButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        await interaction.message.edit(
            embed=embed_builder(
                author=[member.display_avatar.url, f"{member.name}'s Avatar"],
...
class BannerButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        await interaction.message.edit(
            embed=embed_builder(
                author=[member.display_avatar.url, f"{member.name}'s Banner"],
...
class AvatarView(discord.ui.View):
    def __init__(self, member):
        ...
        self.add_item(
            AvatarButton(
                "View Avatar", discord.ButtonStyle.secondary, f"avatar{member.id}"
            )
        )
        self.add_item(
            BannerButton(
                "View Banner", discord.ButtonStyle.secondary, f"banner{member.id}"
            )
        )
